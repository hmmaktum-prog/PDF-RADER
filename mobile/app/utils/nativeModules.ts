...
const PaddleOCRBridge: any = nativePaddleModule ?? {
  ...
  recognizeImage:         () => Promise.resolve(JSON.stringify({ success: false, error: 'Paddle not linked', language: 'unknown', boxes: [], fullText: '', keyInfo: { dates: [], amounts: [], referenceNumbers: [], emails: [], phones: [], urls: [] }, tables: [], formulas: [], layoutInfo: { columns: 1, titles: 0, headings: 0, paragraphs: 0, tableCells: 0, formulas: 0, listItems: 0 } })),
